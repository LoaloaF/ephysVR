...
def setup_array(electrodes, stim_electrodes=None, config_name="default_name"):
    ...
    print(electrodes)
    array.select_electrodes(list(electrodes))
...
def main():
    ...
    PATH = "/run/user/1000/gvfs/smb-share:server=yaniklab-data.local,share=large/BMI/VirtualReality/SpatialSequenceLearning/Simon/impedance/device_4983/impedance_rec3_externalCurrent"
    ...
    # for el_set_i in range(nsets):
        ...
        print(f"Measuring voltage at electrode: {el_smple[0]:05d}", end='\r')
