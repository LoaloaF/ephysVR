...
Extract the important part from it. it could even be a hardcoded adjustment specifically for the 64 channels we have as well. This changes how the design gets gets translated into a physical design. The json file should inidcate the y location of an electrode 
